...
.sidebar-mini.sidebar-collapse .sidebar-menu>li>a {
  ...
  <ul class="sidebar-menu">
	...
	{
		/* Feature Removed
		 * The if statement conditionally skips over certain features
		 */
		if (($menu["menu_title"] == "Workouts") || ($menu["menu_title"] == "Assigned Workouts")|| ($menu["menu_title"] == "Nutrition Schedule"))
		{
			continue;
		}
	?>
