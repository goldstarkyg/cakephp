...
<?php } ?>
     ...
     <!-- <form action="#" method="get" class="sidebar-form">
          ...
          <!-- <li class="header">MAIN NAVIGATION</li> -->
            ...
            <li class="treeview <?php echo ($this->request->controller == "MemberRegistration") ? "active" : "";?>">
              <!-- <a href="<?php echo $this->request->base;?>/MemberRegistration/"> -->
              <a href="<?php echo $this->Gym->createurl("MemberRegistration","index");?>">
                <i class="fa fa-user"></i> <span><?php echo __('Member Registration');?></span>
              </a>
            </li>
            <li class="treeview <?php echo ($this->request->controller == "MemberAttendance") ? "active" : "";?>">
              <!-- <a  href="<?php echo $this->request->base;?>/MemberRegistration/attendance">Attendance</a> -->
              <a href="<?php echo $this->Gym->createurl("MemberAttendance","attendance");?>"> 
                <i class="fa fa-braille"></i> <span><?php echo __('Member Attendance');?></span>
              </a>
            </li>
			...
			<li class="treeview <?php echo ($this->request->controller == "ClassSchedule") ? "active" : "";?>">
			  ...
			  <ul class="treeview-menu">					
					...
					<!-- Feature Removed - Nutrion Schedule-->
					<!-- <li class="<?php echo ($this->request->action == "nutritionList" || $this->request->action == "addnutritionSchedule" || $this->request->action == "viewNutirion") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("GymNutrition","nutritionList");?>"><i class="fa fa-circle-o"></i><?php echo __('Meal Plan');?></a>
					</li> -->	
			...
			<li class="treeview <?php echo ($this->request->controller == "GymMember" || $this->request->controller == "StaffMembers" || $this->request->controller == "GymAccountant") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymMember","memberList");?>">
                <i class="fa fa-user"></i> <span><?php echo __('Member Management');?></span><i class="fa fa-angle-left <?php echo $pull;?>"></i>
              </a>
			   <ul class="treeview-menu">
			...
			-->
			<!-- Feature Removed Store and Product
			...
			<li class="treeview <?php echo ($this->request->controller == "GymTestimonials") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymTestimonials","testimonialsList");?>">
                <i class="fa fa-life-ring"></i> <span><?php echo __('Testimonial');?></span><i class="fa fa-angle-left <?php echo $pull;?>"></i>
              </a>
			   <ul class="treeview-menu">
					<li class="<?php echo ($this->request->action == "addTestimonials") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("GymTestimonials","addTestimonials");?>"><i class="fa fa-circle-o"></i><?php echo __('Add New Testimonial');?></a>
					</li>
					<li class="<?php echo ($this->request->action == "testimonialsList") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("GymTestimonials","testimonialsList");?>">
							<i class="fa fa-circle-o"></i><span><?php echo __('View All');?></span></i>
						</a>
					</li>					
              </ul>			  
			</li>
			<li class="treeview <?php echo ($this->request->controller == "GymMessage" || $this->request->controller == "GymEmail") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymMessage","composeMessage");?>">
                <i class="fa fa-commenting"></i> <span><?php echo __("Message");?></span><i class="fa fa-angle-left <?php echo $pull;?>"></i>  
              </a>
              <ul class="treeview-menu">
					<li class="<?php echo ($this->request->action == "GymMessage") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("GymMessage","composeMessage");?>"><i class="fa fa-circle-o"></i><?php echo __('Message');?></a>
					</li>
					<li class="<?php echo ($this->request->action == "GymEmail") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("GymEmail","composeMessage");?>">
							<i class="fa fa-circle-o"></i><span><?php echo __('Email');?></span></i>
						</a>
					</li>					
              </ul>	
			</li>
			...
			<li class="treeview <?php echo ($this->request->controller == "GymNutrition") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymNutrition","nutritionList");?>">
                <i class="fa fa-cutlery"></i> <span><?php echo __("Meal Plan");?></span></i>
              </a>              
			</li>	
			...
			<li class="treeview <?php echo ($this->request->controller == "GymCalculator") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymCalculator","calculatorBmi");?>">
                <i class="fa fa-calculator"></i> <span><?php echo __("Calculator BMI");?></span></i>
              </a>              
			</li>
			 <!--			
