...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php
		  ...
		  <?php } ?>	
			...
			echo "<img src='{$this->request->webroot}webroot/upload/{$src}' style='width:300px'><br><br><br>";
			echo "</div>";
			...
			echo "<div class='col-md-offset-2'>";
			echo "<img src='{$this->request->webroot}webroot/upload/{$src}' style='width:300px;'>";
			echo "</div>";
			echo "</fieldset><br><br>";
	...
	<?php	}			
			...
			echo "<fieldset>";
			echo "<legend>".__('Email Comment Setting')."</legend>";
			...
			echo "<div class='form-group'>";						
			echo "<label class='control-label col-md-2'>".__("Email Comment")."</label>";
			echo "<div class='col-md-8'>";
