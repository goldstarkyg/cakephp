		...
		<div class="col-md-10">
			<div class="mailbox-content">
				<div class="message-header">
					<h3><span><?php echo __("Subject");?> :</span>  <?php $subject = base64_decode($message['subject'], 'utf-8'); echo $subject;?></h3>
				...
				<div class="message-content">
					<p><?php $message_body= base64_decode($message['message_body'], 'utf-8'); echo $message_body;?></p>
				</div>
