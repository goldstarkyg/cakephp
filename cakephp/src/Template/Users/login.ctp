...
$logo = (!empty($logo)) ? $this->request->base ."/webroot/upload/" . $logo : $this->request->base ."/webroot/upload/logo1.png";
?>
<div class="form">
 ...
 <!-- <form class="register-form">
  ...
  <?php //echo $this->Form->create(["class"=>"login-form","method"=>"post","action"=>"GymLogin/index"]);?>
   ...
   <p class="message">
       <!--<a href="<?php echo $this->request->base;?>/MemberRegistration/"><?php echo __("Member Registration");?></a>&nbsp;&nbsp;|&nbsp;&nbsp;-->
