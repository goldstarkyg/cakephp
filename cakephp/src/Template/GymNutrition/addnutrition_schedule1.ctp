		...
		<div class="form-group">
			...
			<div class="col-sm-10 border">
				...
				<div class="col-md-4">					
					...
					<div class='form-group' style="padding-left: 15px;padding-right:15px;margin-top:20px;">	
						<label class="control-label" for="email">Image Upload<span class="text-danger"> *</span></label>
				        <div class="">
					    <input type="file" name="image" class="form-control"/>
					    <?php $image = ($edit && !empty($data['image'])) ? $data['image'] : "logo.png"; ?>
			            <?php echo "<br><img src='{$this->request->webroot}webroot/upload/{$image}' style='width:90%'>";?>
						</div>	
					</div>	  
				...
				<div class="col-md-8 activity_list" style="height:600px">
					...
					<!-- <label class="activity_title checkbox">
			  		...
			  		<label class="activity_title checkbox">
			  			<strong>
			  				...
			  				id="lunch"  activity_title = "" data-val="nutrition_time"><?php echo __('Lunch');?>
		  				</strong>
	  				</label>
					...
					<div id="txt_afternoonsnacks"></div>-->
	  				<label class="activity_title checkbox">
	  					<strong>
			  				...
			  				id="dinner"  activity_title = "" data-val="nutrition_time"><?php  echo __('Dinner');?>
		  				</strong>
	  				</label>	
