...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<div class="box-body">
		<?php
			echo $this->Form->create("addnutritionSchedule",["type"=>"file","class"=>"validateForm form-horizontal", "onsubmit"=>"return validate_multiselect()", "role"=>"form"]);
		...
		<div class='form-group'>
			...
			<div class="col-md-6">
				<?php 
					echo $this->Form->select("user_id",$members,["default"=>($edit)?$this->request->params["pass"]:"","empty"=>__("Select Member"),"class"=>"mem_list","id"=>"member_list","required"=>"true"]);					
				?>
			</div>
			<div class="col-md-3">
				    ...
				    <div style="margin-top:10px">
				        ...
				        <div class="col-md-8">
				        	<label class="activity_title checkbox">				  							  		
						  		<input type="checkbox" class="nutrition_check" id="breakfast_1"  activity_title = "" data-val="nutrition_time">Break Fast							
							</label>
							<textarea type="textarea" rows="2" name="breakfast1" id="text_breakfast_1" style="display: none; margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="lunch_1"  activity_title = "" data-val="nutrition_time">Lunch							
							</label>
							<textarea type="textarea" rows="2" name="lunch1" id="text_lunch_1" style="display: none;margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="dinner_1"  activity_title = "" data-val="nutrition_time">Dinner							
							</label>
							<textarea type="textarea" rows="2" name="dinner1" id="text_dinner_1" style="display: none;margin-left:40px;width:90%;"></textarea>
				        </div>							
		            </div>
                    <!-- monday -->
                    <div style="margin-top:10px">
				        ...
				        <div class="col-md-8">
				        	<label class="activity_title checkbox">				  							  		
						  		<input type="checkbox" class="nutrition_check" id="breakfast_2"  activity_title = "" data-val="nutrition_time">Break Fast							
							</label>
							<textarea type="textarea" rows="2" name="breakfast2" id="text_breakfast_2" style="display: none; margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="lunch_2"  activity_title = "" data-val="nutrition_time">Lunch							
							</label>
							<textarea type="textarea" rows="2" name="lunch2" id="text_lunch_2" style="display: none;margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="dinner_2"  activity_title = "" data-val="nutrition_time">Dinner							
							</label>
							<textarea type="textarea" rows="2" name="dinner2" id="text_dinner_2" style="display: none;margin-left:40px;width:90%;"></textarea>
				        </div>							
		            </div>		            
			        <!-- tuesday -->
			            <div style="margin-top:10px">
				        ...
				        <div class="col-md-8">
				        	<label class="activity_title checkbox">				  							  		
						  		<input type="checkbox" class="nutrition_check" id="breakfast_3"  activity_title = "" data-val="nutrition_time">Break Fast							
							</label>
							<textarea type="textarea" rows="2" name="breakfast3" id="text_breakfast_3" style="display: none; margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="lunch_3"  activity_title = "" data-val="nutrition_time">Lunch							
							</label>
							<textarea type="textarea" rows="2" name="lunch3" id="text_lunch_3" style="display: none;margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="dinner_3"  activity_title = "" data-val="nutrition_time">Dinner							
							</label>
							<textarea type="textarea" rows="2" name="dinner3" id="text_dinner_3" style="display: none;margin-left:40px;width:90%;"></textarea>
				        </div>							
		            </div>		
			        <!-- wednesday -->
			            <div style="margin-top:10px">
				        ...
				        <div class="col-md-8">
				        	<label class="activity_title checkbox">				  							  		
						  		<input type="checkbox" class="nutrition_check" id="breakfast_4"  activity_title = "" data-val="nutrition_time">Break Fast							
							</label>
							<textarea type="textarea" rows="2" name="breakfast4" id="text_breakfast_4" style="display: none; margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="lunch_4"  activity_title = "" data-val="nutrition_time">Lunch							
							</label>
							<textarea type="textarea" rows="2" name="lunch4" id="text_lunch_4" style="display: none;margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="dinner_4"  activity_title = "" data-val="nutrition_time">Dinner							
							</label>
							<textarea type="textarea" rows="2" name="dinner4" id="text_dinner_4" style="display: none;margin-left:40px;width:90%;"></textarea>
				        </div>							
		            </div>		
			        <!-- thursday -->
			        <div style="margin-top:10px">
				        ...
				        <div class="col-md-8">
				        	<label class="activity_title checkbox">				  							  		
						  		<input type="checkbox" class="nutrition_check" id="breakfast_5"  activity_title = "" data-val="nutrition_time">Break Fast							
							</label>
							<textarea type="textarea" rows="2" name="breakfast5" id="text_breakfast_5" style="display: none; margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="lunch_5"  activity_title = "" data-val="nutrition_time">Lunch							
							</label>
							<textarea type="textarea" rows="2" name="lunch5" id="text_lunch_5" style="display: none;margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="dinner_5"  activity_title = "" data-val="nutrition_time">Dinner							
							</label>
							<textarea type="textarea" rows="2" name="dinner5" id="text_dinner_5" style="display: none;margin-left:40px;width:90%;"></textarea>
				        </div>							
		            </div>		
			        <!-- Friday -->
			        <div style="margin-top:10px">
				        ...
				        <div class="col-md-8">
				        	<label class="activity_title checkbox">				  							  		
						  		<input type="checkbox" class="nutrition_check" id="breakfast_6"  activity_title = "" data-val="nutrition_time">Break Fast							
							</label>
							<textarea type="textarea" rows="2" name="breakfast6" id="text_breakfast_6" style="display: none; margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="lunch_6"  activity_title = "" data-val="nutrition_time">Lunch							
							</label>
							<textarea type="textarea" rows="2" name="lunch6" id="text_lunch_6" style="display: none;margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="dinner_6"  activity_title = "" data-val="nutrition_time">Dinner							
							</label>
							<textarea type="textarea" rows="2" name="dinner6" id="text_dinner_6" style="display: none;margin-left:40px;width:90%;"></textarea>
				        </div>							
		            </div>		
			        <!-- saturday -->
			        <div style="margin-top:10px">
				        ...
				        <div class="col-md-8">
				        	<label class="activity_title checkbox">				  							  		
						  		<input type="checkbox" class="nutrition_check" id="breakfast_7"  activity_title = "" data-val="nutrition_time">Break Fast							
							</label>
							<textarea type="textarea" rows="2" name="breakfast7" id="text_breakfast_7" style="display: none; margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="lunch_7"  activity_title = "" data-val="nutrition_time">Lunch							
							</label>
							<textarea type="textarea" rows="2" name="lunch7" id="text_lunch_7" style="display: none;margin-left:40px;width:90%;"></textarea>
							
						    <label class="activity_title checkbox">				  		
						  		<input type="checkbox" class="nutrition_check" id="dinner_7"  activity_title = "" data-val="nutrition_time">Dinner							
							</label>
							<textarea type="textarea" rows="2" name="dinner7" id="text_dinner_7" style="display: none;margin-left:40px;width:90%;"></textarea>
				        </div>							
		            </div>		 
