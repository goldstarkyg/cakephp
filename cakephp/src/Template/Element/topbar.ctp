...
<header class="main-header">        
        ...
        <nav class="navbar navbar-static-top" role="navigation">
		  ...
		  <span class="top-title">	
			...
			<span style="height: 100%;max-width: 50px;display: inline-block;background-color: #fff;line-height: 50px; border-radius: 40px;">
			<?php echo $this->Html->image($logo,["style"=>"max-height: 100%;max-width: 100%;border-radius:50%;"]);?>
			</span>
			 &nbsp;&nbsp;&nbsp;				
