...
?>
<script>
/* Feature Removed, height changed from 2500 to 1150px*/
$(".content-wrapper").css("height","1150px");
		...
		<div class="row">
			...
			<div class="col-md-8 pull-right">
				...
				<table class="table">
					...
					<tr>
						<th><i class="fa fa-briefcase"></i>&nbsp;&nbsp;&nbsp;<?php echo __("Workplace");?></th>
						<td class="txt_color"><?php echo $data['middle_name'];?></td>
					</tr>
					<tr>
			...
			<!-- <span class="report_title">
				<span class="fa-stack fa-sm">
					...
					<tr>
						<th><i class="fa fa-heart"></i>&nbsp;&nbsp;&nbsp;<?php echo __("Goal");?></th>
