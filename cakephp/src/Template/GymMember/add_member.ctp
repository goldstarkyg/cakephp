...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php				
			...
			echo $this->Form->radio("gender",$radio,['default'=>($edit)?$data["gender"]:"female"]);			
			echo "</div>";	
			echo "</div>";
			...
			echo $this->Form->day('birth_day', ['empty' => ['day' => false],'day' => ['class' => 'form-control validate[required]','id' => 'birth_date_day','style'=>'width:32%;margin-right:1%']]);
			echo $this->Form->month('birth_month', ['monthNames' => true,'empty' => ['month' => false],'month' => ['class' => 'form-control validate[required]','id' => 'birth_date_month','style'=>'width:32%;margin-right:1%']]);
			echo $this->Form->year('birth_year', ['minYear' => 1950,'maxYear' => date("Y"),'empty' => ['year'=>false],'year' => ['class' => 'form-control  validate[required]','id' => 'birth_date_year','style'=>'width:34%']]);
			...
			echo "</div>";	
			echo '<div class="col-md-2">';
			echo "<a href='{$this->request->base}/GymGroup/addGroup/' clas s='btn btn-flat btn-default'>".__("Add Group")."</a>";
			echo "</div>";	
			echo "</div>";
			echo "</fieldset>";
			...
			echo $this->Form->input("",["label"=>false,"name"=>"username","id"=>"username", "class"=>"form-control validate[required]","value"=>(($edit)?$data['username']:'')]);
			echo "</div>";	
			echo "</div>";
			...
			echo '<div class="col-md-6">';			
			echo @$this->Form->select("intrested_area",$interest,["default"=>$data['intrested_area'],"empty"=>__("Select Goal"),"class"=>"form-control interest_list"]);
			echo "</div>";	
			// echo '<div class="col-md-2">';
			...
			<?php
			//}
			echo "<div class='form-group class-member'>";//Membership Valid From	
