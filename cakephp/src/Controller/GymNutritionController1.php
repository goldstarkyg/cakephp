...
class GymNutritionController extends AppController
{
	...
	public function addNutritionSchedule()
	{
		...
		{	
			...
			$data['image'] = (!empty($image)) ? $image : "logo.png";   
	...
	public function viewNutirion($id)
	{
		...
		$data = $this->GymNutrition->find()->where(["GymNutrition.user_id"=>$id])->select(["GymNutrition.start_date","GymNutrition.expire_date","GymNutrition.image"]);
